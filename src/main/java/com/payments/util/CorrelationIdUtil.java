...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<ErrorResponse>> handleAuthenticationExceptions(
        ...
        logger.error("Authentication error: {}", errorResponse);
    ...
    public ResponseEntity<ApiResponse<ErrorResponse>> handleAccessDeniedExceptions(
        ...
        logger.error("Access denied error: {}", errorResponse);
    ...
    public ResponseEntity<ApiResponse<ErrorResponse>> handleBadCredentialsExceptions(
            BadCredentialsException ex, WebRequest request) {
        
        ErrorResponse errorResponse = new ErrorResponse("BAD_CREDENTIALS", ex.getMessage());
        errorResponse.setCorrelationId(CorrelationIdUtil.getCorrelationId());
        
        logger.error("Bad credentials error: {}", errorResponse);
        return new ResponseEntity<>(errorResponse, HttpStatus.UNAUTHORIZED);
    }
    ...
    public ResponseEntity<ApiResponse<ErrorResponse>> handleGlobalExceptions(
        ...
        logger.error("Global error: {}", errorResponse, ex);
...
/**
 * Webhook event entity for storing incoming webhook data.
 * 
 * Key features:
...
@Table(name = "webhook_events", indexes = {
    ...
    @Index(name = "idx_webhook_type", columnList = "eventType")
})
@EntityListeners(AuditingEntityListener.class)
 ...
 * Contains validation for all payment fields.
 */
 ...
 * Contains all relevant payment information for the client.
 */
public class PaymentResponse {
    ...
    public PaymentResponse(Long id, String orderNumber, BigDecimal amount, String currency, 
                          Payment.PaymentType type, Payment.PaymentStatus status) {
        this.id = id;
...
```java:src/main/java/com/payments/model/dto/SubscriptionRequest.java
package com.payments.model.dto;
...
public class ErrorResponse {
    ...
    public String getCorrelationId() { return correlationId; }
    public void setCorrelationId(String correlationId) { this.correlationId = correlation
